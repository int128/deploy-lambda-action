...
var tokenProviders = __webpack_require__(9683);
...
const resolveSSOCredentials = async ({ ssoStartUrl, ssoSession, ssoAccountId, ssoRegion, ssoRoleName, ssoClient, clientConfig, parentClientConfig, callerClientConfig, profile, filepath, configFilepath, ignoreCache, logger, }) => {
    ...
    const { SSOClient, GetRoleCredentialsCommand } = await Promise.resolve().then(function () { return __webpack_require__(2560); });
    const sso = ssoClient ||
...
var sso = __webpack_require__(4960);
...
var client$1 = __webpack_require__(4140);
...
var httpAuthSchemes = __webpack_require__(7647);
var serde = __webpack_require__(4640);
var nodeHttpHandler = __webpack_require__(9169);
var protocols$1 = __webpack_require__(3156);
...
const getSsoOidcClient = async (ssoRegion, init = {}, callerClientConfig) => {
    const { SSOOIDCClient } = await __webpack_require__.e(/* import() */ 878).then(__webpack_require__.t.bind(__webpack_require__, 7878, 19));
...
const getNewSsoOidcToken = async (ssoToken, ssoRegion, init = {}, callerClientConfig) => {
    const { CreateTokenCommand } = await __webpack_require__.e(/* import() */ 878).then(__webpack_require__.t.bind(__webpack_require__, 7878, 19));
