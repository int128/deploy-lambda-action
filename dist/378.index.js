...
var credentialProviderLogin = __webpack_require__(5576);

const resolveCredentialSource = (credentialSource, profileName, logger) => {
    const sourceProvidersMap = {
        EcsContainer: async (options) => {
            const { fromHttp } = await __webpack_require__.e(/* import() */ 354).then(__webpack_require__.bind(__webpack_require__, 2354));
        ...
        Environment: async (options) => {
            ...
            const { fromEnv } = await Promise.resolve(/* import() */).then(__webpack_require__.t.bind(__webpack_require__, 9885, 19));
...
const resolveAssumeRoleCredentials = async (profileName, profiles, options, callerClientConfig, visitedProfiles = {}, resolveProfileData) => {
    ...
    if (!options.roleAssumer) {
        const { getDefaultRoleAssumer } = await Promise.all(/* import() */[__webpack_require__.e(465), __webpack_require__.e(680)]).then(__webpack_require__.t.bind(__webpack_require__, 2680, 23));
...
const resolveProcessCredentials = async (options, profile) => __webpack_require__.e(/* import() */ 309).then(__webpack_require__.t.bind(__webpack_require__, 5309, 19)).then(({ fromProcess }) => fromProcess({
    ...options,
    profile,
...
const resolveSsoCredentials = async (profile, profileData, options = {}, callerClientConfig) => {
    const { fromSSO } = await Promise.all(/* import() */[__webpack_require__.e(465), __webpack_require__.e(140)]).then(__webpack_require__.t.bind(__webpack_require__, 6140, 19));
    return fromSSO({
        profile,
...
const isWebIdentityProfile = (arg) => Boolean(arg) &&
    ...
    typeof arg.role_arn === "string" &&
    ["undefined", "string"].indexOf(typeof arg.role_session_name) > -1;
const resolveWebIdentityCredentials = async (profile, options, callerClientConfig) => Promise.all(/* import() */[__webpack_require__.e(465), __webpack_require__.e(146)]).then(__webpack_require__.t.bind(__webpack_require__, 1146, 23)).then(({ fromTokenFile }) => fromTokenFile({
...
class LoginCredentialsFetcher {
    ...
    async refresh(token) {
        const { SigninClient, CreateOAuth2TokenCommand } = await Promise.all(/* import() */[__webpack_require__.e(465), __webpack_require__.e(642)]).then(__webpack_require__.t.bind(__webpack_require__, 3642, 23));
...
//# sourceMappingURL=378.index.js.map