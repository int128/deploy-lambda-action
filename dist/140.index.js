...
var client = __webpack_require__(9139);
var tokenProviders = __webpack_require__(5724);
...
const resolveSSOCredentials = async ({ ssoStartUrl, ssoSession, ssoAccountId, ssoRegion, ssoRoleName, ssoClient, clientConfig, parentClientConfig, callerClientConfig, profile, filepath, configFilepath, ignoreCache, logger, }) => {
    ...
    const { SSOClient, GetRoleCredentialsCommand } = await Promise.resolve().then(function () { return __webpack_require__(967); });
    const sso = ssoClient ||
...
var sso = __webpack_require__(7691);
...
const ruleset_1 = __webpack_require__(499);
...
var protocolHttp = __webpack_require__(9228);
var schemas_0 = __webpack_require__(7295);
var errors = __webpack_require__(5435);
var SSOServiceException = __webpack_require__(6321);
...
const httpAuthSchemeProvider_1 = __webpack_require__(8004);
const endpointResolver_1 = __webpack_require__(8778);
const schemas_0_1 = __webpack_require__(7295);
const getRuntimeConfig = (config) => {
    return {
...
var client = __webpack_require__(9139);
var httpAuthSchemes = __webpack_require__(6008);
var propertyProvider = __webpack_require__(4036);
var sharedIniFileLoader = __webpack_require__(7016);
...
const getSsoOidcClient = async (ssoRegion, init = {}, callerClientConfig) => {
    const { SSOOIDCClient } = await __webpack_require__.e(/* import() */ 971).then(__webpack_require__.t.bind(__webpack_require__, 8971, 23));
...
const getNewSsoOidcToken = async (ssoToken, ssoRegion, init = {}, callerClientConfig) => {
    const { CreateTokenCommand } = await __webpack_require__.e(/* import() */ 971).then(__webpack_require__.t.bind(__webpack_require__, 8971, 23));
