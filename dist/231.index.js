...
var client = __webpack_require__(3062);
var tokenProviders = __webpack_require__(4921);
...
const resolveSSOCredentials = async ({ ssoStartUrl, ssoSession, ssoAccountId, ssoRegion, ssoRoleName, ssoClient, clientConfig, parentClientConfig, callerClientConfig, profile, filepath, configFilepath, ignoreCache, logger, }) => {
    ...
    const { SSOClient, GetRoleCredentialsCommand } = await Promise.resolve().then(function () { return __webpack_require__(2870); });
    const sso = ssoClient ||
...
var sso = __webpack_require__(186);
...
const httpAuthSchemes_1 = __webpack_require__(6065);
...
const util_endpoints_1 = __webpack_require__(8511);
const util_endpoints_2 = __webpack_require__(4773);
const ruleset_1 = __webpack_require__(5104);
...
var middlewareUserAgent = __webpack_require__(8665);
var configResolver = __webpack_require__(2754);
var core = __webpack_require__(8653);
var schema = __webpack_require__(753);
var middlewareContentLength = __webpack_require__(762);
var middlewareEndpoint = __webpack_require__(3398);
var middlewareRetry = __webpack_require__(1709);
var smithyClient = __webpack_require__(7058);
var httpAuthSchemeProvider = __webpack_require__(821);
var runtimeConfig = __webpack_require__(2780);
var regionConfigResolver = __webpack_require__(6099);
var protocolHttp = __webpack_require__(9526);
var schemas_0 = __webpack_require__(4674);
var errors = __webpack_require__(4198);
var SSOServiceException = __webpack_require__(7038);
...
const smithy_client_1 = __webpack_require__(7058);
...
const SSOServiceException_1 = __webpack_require__(7038);
...
const package_json_1 = tslib_1.__importDefault(__webpack_require__(4639));
const client_1 = __webpack_require__(3062);
const httpAuthSchemes_1 = __webpack_require__(6065);
const util_user_agent_node_1 = __webpack_require__(3506);
const config_resolver_1 = __webpack_require__(2754);
const hash_node_1 = __webpack_require__(4550);
const middleware_retry_1 = __webpack_require__(1709);
const node_config_provider_1 = __webpack_require__(1275);
const node_http_handler_1 = __webpack_require__(5435);
const smithy_client_1 = __webpack_require__(7058);
const util_body_length_node_1 = __webpack_require__(6000);
const util_defaults_mode_node_1 = __webpack_require__(8920);
const util_retry_1 = __webpack_require__(1378);
const runtimeConfig_shared_1 = __webpack_require__(4061);
...
exports.getRuntimeConfig = void 0;
const httpAuthSchemes_1 = __webpack_require__(6065);
const protocols_1 = __webpack_require__(5202);
const core_1 = __webpack_require__(8653);
const smithy_client_1 = __webpack_require__(7058);
...
const httpAuthSchemeProvider_1 = __webpack_require__(821);
const endpointResolver_1 = __webpack_require__(187);
const schemas_0_1 = __webpack_require__(4674);
const getRuntimeConfig = (config) => {
    return {
...
const schema_1 = __webpack_require__(753);
const errors_1 = __webpack_require__(4198);
const SSOServiceException_1 = __webpack_require__(7038);
...
var client = __webpack_require__(3062);
var httpAuthSchemes = __webpack_require__(6065);
var propertyProvider = __webpack_require__(7930);
var sharedIniFileLoader = __webpack_require__(9498);
...
const getSsoOidcClient = async (ssoRegion, init = {}, callerClientConfig) => {
    const { SSOOIDCClient } = await __webpack_require__.e(/* import() */ 308).then(__webpack_require__.t.bind(__webpack_require__, 1308, 23));
...
const getNewSsoOidcToken = async (ssoToken, ssoRegion, init = {}, callerClientConfig) => {
    const { CreateTokenCommand } = await __webpack_require__.e(/* import() */ 308).then(__webpack_require__.t.bind(__webpack_require__, 1308, 23));
